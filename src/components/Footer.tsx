...
import { Phone, MapPin, MessageCircle, Globe, ArrowUpRight } from 'lucide-react';
  ...
  return (
    <footer className="bg-white relative">
      ...
      <div className="max-w-7xl mx-auto px-8 pt-20 md:pt-28 pb-12">
          ...
          <div>
            ...
            <div className="flex flex-col gap-5">
              ...
              <a href="https://pf.kakao.com/" target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-[13px] font-medium px-5 py-2.5 rounded-xl w-fit bg-yellow-50 text-yellow-700 transition-all duration-300 hover:bg-yellow-100 hover:shadow-sm">
        ...
        {/* Bottom */}
        <div className="mt-20 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 border-t border-gray-100/80">
